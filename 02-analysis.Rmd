...
Figure 2 shows boxplots of the foreshore slope, organized by location.
...
Figure 2. Boxplots of foreshore slope.

</center>


The test results for the paired t-test and the Wilcoxon signed-rank test for foreshore slope are shown below, as well as plots of the individual differences between the nest line and other locations (Figure 3). Differences were computed by subtracting the listed location from the nest line. East and West differences were computed by subtracting the West measurement from the East measurement. Statistical significance was defined as $\alpha = 0.1$
...
Figure 3. Dot plots of differences in foreshore slope between nest line and other locations.


Table 1. Analysis results for foreshore slope with only loggerhead nests.
...
Table 2. Analysis for east vs. west comparisons with loggerhead nests only. 
...
Table 3. Analysis results for foreshore slope with loggerhead nests and green turtle nest.
...
Table 4. Analysis for east vs. west comparisons for foreshore slope with loggerhead nests and the green turtle nest. 
...
Figure 4 shows boxplots of the beach slope, organized by location.
...
Figure 4. Boxplots of beach slope

</center>

The test results for the paired t-test and the Wilcoxon signed-rank test for beach slope are shown below, as well as plots of the individual differences between the nest line and other locations (Figure 5). Differences were computed by subtracting the listed location from the nest line. East and West differences were computed by subtracting the West measurement from the East measurement. Statistical significance was defined as $\alpha = 0.1$
...
Figure 5. Dot plots of differences in beach slope between nest line and other locations.

Table 5. Analysis results for beach slope with only loggerhead nests.
...
Table 6. Analysis for east vs. west comparisons with loggerhead nests only. 
...
Table 7. Analysis results for beach slope with loggerhead nests and green turtle nest.
...
Table 8. Analysis for east vs. west comparisons for beach slope with loggerhead nests and the green turtle nest. 
...
Figure 6 shows boxplots of the beach width, organized by location.
...
Figure 6. Boxplots of beach width.

</center>

The test results for the paired t-test and the Wilcoxon signed-rank test for beach width are shown below, as well as plots of the individual differences between the nest line and other locations (Figure 7). Differences were computed by subtracting the listed location from the nest line. East and West differences were computed by subtracting the West measurement from the East measurement. Statistical significance was defined as $\alpha = 0.1$
...
Figure 7. Dot plots of differences in beach width between nest line and other locations.


Table 9. Analysis results for beach width with only loggerhead nests.
</center>
...
Table 10. Analysis for east vs. west comparisons with loggerhead nests only. 
...
Table 11. Analysis results for beach width with loggerhead nests and green turtle nest.
...
Table 12. Analysis for east vs. west comparisons for beach width with loggerhead nests and the green turtle nest. 
...
Figure 8 shows boxplots of the foredune height, organized by location.
...
Figure 8. Boxplots of foredune height

</center>

The test results for the paired t-test and the Wilcoxon signed-rank test for foredune height are shown below, as well as plots of the individual differences between the nest line and other locations (Figure 9). Differences were computed by subtracting the listed location from the nest line. East and West differences were computed by subtracting the West measurement from the East measurement. Statistical significance was defined as $\alpha = 0.1$
...
Figure 9. Dot plots of differences in foredune height between nest line and other locations.

Table 13. Analysis results for foreshore slope with only loggerhead nests.
...
Table 14. Analysis for east vs. west comparisons with loggerhead nests only. 
...
Table 15. Analysis results for foredune height with loggerhead nests and green turtle nest.
...
Table 16. Analysis for east vs. west comparisons for foreshore slope with loggerhead nests and the green turtle nest. 
