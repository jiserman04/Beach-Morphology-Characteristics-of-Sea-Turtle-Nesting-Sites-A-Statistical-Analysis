...
Figure 1 provides and image of the observed locations.

<center>

![](measurement locations.png)

Figure 1. Observed locations.
...
-	$t_{\alpha/2}$ is the critical value
   - 1 - $\alpha$/2 is the cinfidence level
