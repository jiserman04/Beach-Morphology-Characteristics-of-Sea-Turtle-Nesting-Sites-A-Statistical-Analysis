...
## Analysis with Green Turtles {-}

Below are the analysis results including the green turtle nest.

### Foreshore Slope {-}

<center>

Table A1. Analysis results for foreshore slope with loggerhead nests and green turtle nest.
...
Table A2. Foreshore slope analysis for east vs. west comparisons with loggerhead nests and the green turtle nest. 
...
Table A4. Beach slope analysis for east vs. west comparisons with loggerhead nests and the green turtle nest. 
...
Table A6. Beach width analysis for east vs. west comparisons with loggerhead nests and the green turtle nest. 
...
Table A8. Foredune height analysis for east vs. west comparisons with loggerhead nests and the green turtle nest. 
